...
const char* WIFI_SSID = "MySpectrumWiFi3e-2G";
const char* WIFI_PWD = "widebubble993";

#define TZ              -5       // (utc+) TZ in hours  change the timezone gmt offset 
...
#if defined(ESP8266)
const int SDA_PIN = D2;           //set up the pin for the ic
...
String OPEN_WEATHER_MAP_APP_ID = "471222fa443cf97b19a3b81967dabe4a";   //api 
String OPEN_WEATHER_MAP_LOCATION_ID = "4469146";                       //location in greensboro
